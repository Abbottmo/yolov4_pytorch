...
Cfg.use_darknet_cfg = False   ## to change ,True for using the darknet vesion backbone from cfg file
...
Cfg.burn_in = 1000
Cfg.classes = 80           ## to change 
Cfg.max_batches = 500500   ## match to the darknet vesion  max_batches = classes * 2000 
Cfg.steps = [400000, 450000]  ## match to the darknet vesion max_batches * 0.8,  max_batches * 0.9  
